  ...
  return new Promise(function (resolve) {
    return dir.createReader().readEntries(function (entries) {
      return Promise.all(entries.filter(function (e) {
        ...
        return (_ref = []).concat.apply(_ref, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(files));
      }).then(resolve);
    });
  });
};
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./src/utils/hot-reload.js");
